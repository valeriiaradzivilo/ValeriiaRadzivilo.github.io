...
import 'package:portfolio/features/old_code/special_widgets/topic_plus_grid.dart';
...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  List gitProjects = [
    ...
    [
      'Firebase database',
      'https://github.com/valeriiaradzivilo/firebase_work_google_course',
      'link',
    ],
    [
      'Language changer (Bloc)',
      'https://github.com/valeriiaradzivilo/language_changer',
      'link',
    ],
    [
      'Authentication Firebase',
      'https://github.com/valeriiaradzivilo/login_signup_system',
      'link',
    ],
    [
      'Music player (Storage)',
      'https://github.com/valeriiaradzivilo/music_player_',
      'link',
    ],
  ];
